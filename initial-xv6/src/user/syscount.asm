...
int main(int argc, char *argv[])
{
  ...
  18:	8d458593          	addi	a1,a1,-1836 # 8e8 <malloc+0x10e>
  1c:	4509                	li	a0,2
  1e:	00000097          	auipc	ra,0x0
  22:	6d6080e7          	jalr	1750(ra) # 6f4 <fprintf>
        exit(1);
  26:	4505                	li	a0,1
  ...
  70:	8bc58593          	addi	a1,a1,-1860 # 928 <malloc+0x14e>
  74:	4509                	li	a0,2
  76:	00000097          	auipc	ra,0x0
  7a:	67e080e7          	jalr	1662(ra) # 6f4 <fprintf>
        exit(1);
  7e:	4505                	li	a0,1
  ...
  8c:	89058593          	addi	a1,a1,-1904 # 918 <malloc+0x13e>
  90:	4509                	li	a0,2
  92:	00000097          	auipc	ra,0x0
  96:	662080e7          	jalr	1634(ra) # 6f4 <fprintf>
        exit(1);
  9a:	4505                	li	a0,1
  ...
  e8:	85450513          	addi	a0,a0,-1964 # 938 <malloc+0x15e>
  ec:	00000097          	auipc	ra,0x0
  f0:	636080e7          	jalr	1590(ra) # 722 <printf>
    }
    exit(0);
  f4:	4501                	li	a0,0
 ...
 106:	7de60613          	addi	a2,a2,2014 # 8e0 <malloc+0x106>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 49e:	5de50513          	addi	a0,a0,1502 # a78 <digits>
 4a2:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 5a4:	48070713          	addi	a4,a4,1152 # a20 <malloc+0x246>
 ...
 630:	44cb8b93          	addi	s7,s7,1100 # a78 <digits>
 ...
 686:	39690913          	addi	s2,s2,918 # a18 <malloc+0x23e>
        while(*s != 0){
...
free(void *ap)
{
 ...
 766:	d4e7b783          	ld	a5,-690(a5) # 14b0 <freep>
 ...
 78e:	00e6ea63          	bltu	a3,a4,7a2 <free+0x4a>
{
 ...
 7d0:	cef73223          	sd	a5,-796(a4) # 14b0 <freep>
}
 7d4:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7fa:	cba53503          	ld	a0,-838(a0) # 14b0 <freep>
 ...
 82a:	c8a90913          	addi	s2,s2,-886 # 14b0 <freep>
  if(p == (char*)-1)
 82e:	5afd                	li	s5,-1
 ...
 83e:	c8678793          	addi	a5,a5,-890 # 14c0 <base>
 842:	00001717          	auipc	a4,0x1
 846:	c6f73723          	sd	a5,-914(a4) # 14b0 <freep>
 84a:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 8bc:	bea73c23          	sd	a0,-1032(a4) # 14b0 <freep>
      return (void*)(p + 1);
